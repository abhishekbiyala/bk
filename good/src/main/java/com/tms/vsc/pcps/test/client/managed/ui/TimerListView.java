...
import com.tms.vsc.pcps.test.client.scaffold.place.AbstractProxyListView;
...
public class TimerListView extends TimerListView_Roo_Gwt {
    ...
    private static com.tms.vsc.pcps.test.client.managed.ui.TimerListView instance;
    ...
    public static com.tms.vsc.pcps.test.client.managed.ui.TimerListView instance() {
        if (instance == null) {
