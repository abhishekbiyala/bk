...
import com.tms.vsc.pcps.test.client.managed.activity.*;
import com.tms.vsc.pcps.test.client.managed.request.ApplicationRequestFactory;
import com.tms.vsc.pcps.test.client.managed.ui.ApplicationListPlaceRenderer;
import com.tms.vsc.pcps.test.client.scaffold.activity.IsScaffoldMobileActivity;
import com.tms.vsc.pcps.test.client.scaffold.place.*;
import com.tms.vsc.pcps.test.client.scaffold.gae.GaeHelper;
import com.tms.vsc.pcps.test.client.style.MobileListResources;
