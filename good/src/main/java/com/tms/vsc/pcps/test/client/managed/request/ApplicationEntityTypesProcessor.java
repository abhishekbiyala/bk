...
public abstract class ApplicationEntityTypesProcessor<T> {
    ...
    private static void process(com.tms.vsc.pcps.test.client.managed.request.ApplicationEntityTypesProcessor<?> processor, Class<?> clazz) {
    ...
    private static void process(com.tms.vsc.pcps.test.client.managed.request.ApplicationEntityTypesProcessor<?> processor, Object proxy) {
