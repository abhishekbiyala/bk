...
public class TimerMobileListView extends TimerMobileListView_Roo_Gwt {
    ...
    private static com.tms.vsc.pcps.test.client.managed.ui.TimerMobileListView instance;
    ...
    public static com.tms.vsc.pcps.test.client.managed.ui.TimerMobileListView instance() {
        if (instance == null) {
