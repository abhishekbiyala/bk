package com.tms.vsc.pcps.test.client.scaffold.place;
 ...
 * {@link com.tms.vsc.pcps.test.client.scaffold.place.Place Place}s your app can navigate to. In
 ...
 * {@link com.tms.vsc.pcps.test.client.scaffold.place.ProxyListPlace ProxyListPlace}s (which show
 * all entities of a particular type) and
 * {@link com.tms.vsc.pcps.test.client.scaffold.place.ProxyPlace ProxyPlace}s (which give access to
